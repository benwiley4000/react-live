...
var LiveProvider = function (_Component) {
  ...
  function LiveProvider() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.onChange = function (code) {
      ...
      _this.setState({ error: error.toString(), errorRaw: error });
      ...
      var errorCallback = function errorCallback(err) {
        _this.setState({ element: undefined, error: err.toString(), errorRaw: err });
      };
      ...
      // State reset object
      var state = { unsafeWrapperError: undefined, error: undefined, errorRaw: null };
      ...
      try {
        ...
        _this.setState(_extends({}, state, { error: error.toString(), errorRaw: error }));
      }
  ...
  LiveProvider.prototype.componentDidUpdate = function componentDidUpdate(prevProps, prevState) {
